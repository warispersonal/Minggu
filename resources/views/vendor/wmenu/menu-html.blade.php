															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																<dl class="menu-item-bar">
																	<dt class="menu-item-handle">
																		<span class="item-title"> <span class="menu-item-title"> <span id="menutitletemp_{{$m->id}}">{{$m->label_en}}</span> <span style="color: transparent;">|{{$m->id}}|</span> </span> <span class="is-submenu" style="@if($m->depth==0)display: none;@endif">Subelement</span> </span>
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="description description-thin">
																		<label for="edit-menu-item-title-{{$m->id}}" class="w-100"> Label (EN)
																			<br>
																			<input type="text" id="idlabelmenuen_{{$m->id}}" class="widefat edit-menu-item-title-en w-100" name="idlabelmenuen_{{$m->id}}" value="{{$m->label_en}}">
																		</label>
																	</p>
																	<p class="description description-thin">
																		<label for="edit-menu-item-title-{{$m->id}}" class="w-100"> Label (BM)
																			<br>
																			<input type="text" id="idlabelmenubm_{{$m->id}}" class="widefat edit-menu-item-title-bm w-100" name="idlabelmenubm_{{$m->id}}" value="{{$m->label_bm}}">
																		</label>
																	</p>

																	<p class="field-css-classes description description-thin mt-2">
																		<label for="edit-menu-item-classes-{{$m->id}}" class="w-100"> Class CSS (optional)
																			<br>
																			<input type="text" id="clases_menu_{{$m->id}}" class="widefat w-100 code edit-menu-item-classes" name="clases_menu_{{$m->id}}" value="{{$m->class}}">
																		</label>
																	</p>

																	<p class="field-css-url description description-wide mt-2">
																		<label for="edit-menu-item-url-{{$m->id}}" class="w-100"> Url
																			<br>
																			<input type="text" id="url_menu_{{$m->id}}" class="widefat w-100 code edit-menu-item-url" id="url_menu_{{$m->id}}" value="{{$m->link}}">
																		</label>
																	</p>
