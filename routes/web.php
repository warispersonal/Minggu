...
Route::prefix('star')->middleware('auth:superAdmin')->namespace('SuperAdmin')->group(function () {
    ...
    Route::prefix('home-page-partner')->group(function () {
        ...
        Route::get('/promotion/{id}/edit', [HomePagePartnerController::class, 'promotion_edit'])->name('admin.stars.promotion.edit');
        ...
        Route::post('/promotion/{id}/update', [HomePagePartnerController::class, 'promotion_update'])->name('admin.stars.promotion.update');
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::get('khidmat-info', 'UsersController@getKhidmatAjax')->name('star.getKhidmatAJAX');
